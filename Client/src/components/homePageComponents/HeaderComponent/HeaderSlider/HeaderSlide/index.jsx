...
const HeaderSlide = () => {
  return (
    <div className="headerSliderContent bg-black  grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-0 text-white py-3 px-5 mt-7">
        <div className="left-side  pt-10 space-y-2">
